...
namespace Kagarr.Core.Download.Clients.Sabnzbd
{
    public class SabnzbdClient : IDownloadClient
    {
        ...
        public SabnzbdClient(string name, SabnzbdSettings settings, HttpClient httpClient)
        {
            _name = name;
            _settings = settings;
        ...
        public static SabnzbdClient FromDefinition(DownloadClientDefinition definition, HttpClient httpClient)
        {
            var settings = JsonConvert.DeserializeObject<SabnzbdSettings>(definition.Settings) ?? new SabnzbdSettings();
            return new SabnzbdClient(definition.Name, settings, httpClient);
        }
    }
}
