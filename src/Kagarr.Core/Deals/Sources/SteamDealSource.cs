...
namespace Kagarr.Core.Deals.Sources
{
    public class SteamDealSource : IDealSource
    {
        ...
        public SteamDealSource(IRateLimitService rateLimitService, IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<List<GameDeal>> GetDealsAsync(string gameTitle, int? steamAppId)
        {
            ...
            try
            {
                ...
                var client = _httpClientFactory.CreateClient("deals");
